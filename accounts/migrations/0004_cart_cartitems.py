# Generated by Django 5.0.1 on 2025-01-12 03:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0003_rename_profile_image_profile_profile_image_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='carts', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
